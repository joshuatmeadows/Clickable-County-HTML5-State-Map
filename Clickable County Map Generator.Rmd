...
The following chunk loads the neccessary libraries.
...
Change the variables in the following chunk to custimize the map for your state and Urls. Use "@county" in the url to have the name of the appropriate county inserted.
